                    ...
                    tasks: [
                        ...
                        },
                        {
                            ...
                            subtasks: [
                                ...
                                { title: "Publish on Indie Hackers", isCompleted: false },
...
export const seedDatabase = mutation({
    ...
    handler: async (ctx) => {
        ...
        for (const boardData of data.boards) {
            ...
            // Insert columns
            for (let colIndex = 0; colIndex < boardData.columns.length; colIndex++) {
                const columnData = boardData.columns[colIndex];
                ...
                for (
                    let taskIndex = 0;
                    taskIndex < columnData.tasks.length;
                    taskIndex++
                ) {
